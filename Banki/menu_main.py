...
class MenuMain(Menu): 
    ...
    def transfer(self) -> None:
        ...
        bank_account_id = self.bank_accounts[choice-1] [0]
        ...
        if Continue:
            ...
            self.db_manger.update_balance(bank_account_id,new_balance)
            self.db_manger.commit_transaction(self.account[0],bank_account_id,transaction_type,recipient_bank_account,amount)
            self.clear_screen()
            print(transfer_ok)
            time.sleep(1.5)
